                ...
                <div class="row">
                    <div class="col-md-10 col-12">
                            ...
                            <form id="searchForm" action="search.jsp" method="GET">
                                <div class="row">
                                    <div class="col-12 col-md-10 col-lg-10 col-sm-10">
                                        <input type="text" id="qtag" name="qtags"> 
                                    </div>
                        ...
                        <%
                            ...
                            int pageCount = dao.countAllQuestions(sID);
                            ...
                            ResultSet qResults = dao.allQuestions(calc_page, countPerPage, sID);
                            while (qResults.next()) {
                                ...
                                int checkStatus = history.checkSkipedQuestion(sID, qID);
                                if (checkStatus != 1) {
                        %>



                        <div class="ques spacebottom" id="ques">
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-10 col-sm-9 qcell">
                                    ...
                                    <div class="prv-answers" id="#prv-answers"><b onclick="location.href = 'answers.jsp?qid=<%= qID%>';">Previous Answers</b>
